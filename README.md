**PROJETO DA DISCIPLINA PGW2 

DETALHES:

Os fãs da franquia Star Wars estão pedindo sua ajuda! Eles ficaram sabendo que está disponível uma API que fornece detalhes sobre seus filmes preferidos. Essa API se chama SWAPI - The Star Wars API (swapi.dev). 
 
A SWAPI fornece informações a respeito de cada filme, dos personagens, dos planetas, dos veículos, das espaçonaves e das espécies encontrados na franquia. Para terem acesso a toda essa informação, os fãs estão te dando uma missão: desenvolver um website que receba os dados dos filmes e os apresente de forma organizada e acessível. 
...
**PGW2 DISCIPLINE PROJECT

DETAILS:

Fans of the Star Wars franchise are asking for your help! They learned that an API is available that provides details about their favorite movies. This API is called SWAPI - The Star Wars API (swapi.dev).

SWAPI provides information about each film, the characters, planets, vehicles, spacecraft and species found in the franchise. To have access to all this information, fans are giving you a mission: develop a website that receives data from the films and presents them in an organized and accessible way.
